...
function Navbar() {
    ...
    return (
        <div className="fixed top-0 left-0 w-full z-50">
            {isOpen && <div className="fixed inset-0 bg-gray-500 opacity-50 z-30" onClick={toggleNavbar}></div>}
            <div className="flex items-center justify-between py-0 px-[40px] lg:px-[60px] bg-white z-40">
                ...
                <nav className={`fixed lg:ml-[200px] bg-gradient-to-r from-orange-500 to-orange-300 lg:bg-none top-0 left-0 h-full w-64 transform transition-transform duration-300 lg:static lg:flex lg:items-center lg:justify-center lg:w-auto ${isOpen ? 'translate-x-0' : '-translate-x-full'} z-40`}>
